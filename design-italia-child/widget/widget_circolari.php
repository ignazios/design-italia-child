...
<?php           
		echo $args['before_widget'];          
           if ( $title ) {
                echo $args['before_title'] . $title . ' <a href="'.site_url('/wp-admin/edit.php?post_type=circolari_scuola&page=Firma').'"><span class="badge badge-pill badge-danger" title="Circolari da firmare">10</span></a>'.$args['after_title'];
            } ?>
