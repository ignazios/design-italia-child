		          ...
		          <div class="img-responsive-wrapper">
		            <div class="img-responsive">
		             ...
		             $img_thumbnail=get_the_post_thumbnail(null,'img-wrapper-thumb');
		             	if($img_thumbnail==""){
		             		echo '<img width="533" height="300" src="'.get_template_directory_uri() . "-child/img/thumbnail-default.png".'" class="attachment-img-wrapper-thumb size-img-wrapper-thumb wp-post-image">';
		             	}else{
		             		echo $img_thumbnail;
		             	}
		             ?>
